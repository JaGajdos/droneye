import{M as ie,V as T,C as I,F as Oe,P as _e,a as te,b as he,c as Se,W as Ge,U as pe,d as ge,S as Me,e as Ze,f as Q,B as be,g as Ne,A as ce,D as le,h as de,i as $e,j as je,k as Ce,l as Be,m as Ie,n as ue,o as Ue,p as De,G as Te,T as fe,q as Le,r as ze,R as Xe,s as He,t as ve}from"./three-BlOKnPzJ.js";import{G as qe}from"./GLTFLoader-C434yn19.js";class Ve extends ie{constructor(n,t={}){super(n),this.isWater=!0;const a=this,r=t.textureWidth!==void 0?t.textureWidth:512,o=t.textureHeight!==void 0?t.textureHeight:512,e=t.clipBias!==void 0?t.clipBias:0,i=t.alpha!==void 0?t.alpha:1,s=t.time!==void 0?t.time:0,c=t.waterNormals!==void 0?t.waterNormals:null,l=t.sunDirection!==void 0?t.sunDirection:new T(.70707,.70707,0),p=new I(t.sunColor!==void 0?t.sunColor:16777215),v=new I(t.waterColor!==void 0?t.waterColor:8355711),M=t.eye!==void 0?t.eye:new T(0,0,0),m=t.distortionScale!==void 0?t.distortionScale:20,h=t.side!==void 0?t.side:Oe,f=t.fog!==void 0?t.fog:!1,g=new _e,w=new T,x=new T,W=new T,S=new te,O=new T(0,0,-1),A=new he,k=new T,E=new T,Z=new he,N=new te,C=new Se,U=new Ge(r,o),$={name:"MirrorShader",uniforms:pe.merge([ge.fog,ge.lights,{normalSampler:{value:null},mirrorSampler:{value:null},alpha:{value:1},time:{value:0},size:{value:1},distortionScale:{value:20},textureMatrix:{value:new te},sunColor:{value:new I(8355711)},sunDirection:{value:new T(.70707,.70707,0)},eye:{value:new T},waterColor:{value:new I(5592405)}}]),vertexShader:`
				...
				}`},D=new Me({name:$.name,uniforms:pe.clone($.uniforms),vertexShader:$.vertexShader,fragmentShader:$.fragmentShader,lights:!0,side:h,fog:f});D.uniforms.mirrorSampler.value=U.texture,D.uniforms.textureMatrix.value=N,D.uniforms.alpha.value=i,D.uniforms.time.value=s,D.uniforms.normalSampler.value=c,D.uniforms.sunColor.value=p,D.uniforms.waterColor.value=v,D.uniforms.sunDirection.value=l,D.uniforms.distortionScale.value=m,D.uniforms.eye.value=M,a.material=D,a.onBeforeRender=function(z,Ee,X){if(x.setFromMatrixPosition(a.matrixWorld),W.setFromMatrixPosition(X.matrixWorld),S.extractRotation(a.matrixWorld),w.set(0,0,1),w.applyMatrix4(S),k.subVectors(x,W),k.dot(w)>0)return;k.reflect(w).negate(),k.add(x),S.extractRotation(X.matrixWorld),O.set(0,0,-1),O.applyMatrix4(S),O.add(W),E.subVectors(x,O),E.reflect(w).negate(),E.add(x),C.position.copy(k),C.up.set(0,1,0),C.up.applyMatrix4(S),C.up.reflect(w),C.lookAt(E),C.far=X.far,C.updateMatrixWorld(),C.projectionMatrix.copy(X.projectionMatrix),N.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),N.multiply(C.projectionMatrix),N.multiply(C.matrixWorldInverse),g.setFromNormalAndCoplanarPoint(w,x),g.applyMatrix4(C.matrixWorldInverse),A.set(g.normal.x,g.normal.y,g.normal.z,g.constant);const _=C.projectionMatrix;Z.x=(Math.sign(A.x)+_.elements[8])/_.elements[0],Z.y=(Math.sign(A.y)+_.elements[9])/_.elements[5],Z.z=-1,Z.w=(1+_.elements[10])/_.elements[14],A.multiplyScalar(2/A.dot(Z)),_.elements[2]=A.x,_.elements[6]=A.y,_.elements[10]=A.z+1-e,_.elements[14]=A.w,M.setFromMatrixPosition(X.matrixWorld);const Ye=z.getRenderTarget(),Re=z.xr.enabled,Fe=z.shadowMap.autoUpdate;a.visible=!1,z.xr.enabled=!1,z.shadowMap.autoUpdate=!1,z.setRenderTarget(U),z.state.buffers.depth.setMask(!0),z.autoClear===!1&&z.clear(),z.render(Ee,C),a.visible=!0,z.xr.enabled=Re,z.shadowMap.autoUpdate=Fe,z.setRenderTarget(Ye);const me=X.viewport;me!==void 0&&z.state.viewport(me)}}}let R,L,H,d=null,j=[];const Je=18,V=new Ne,ne=new Map;let b=[],P=0,y=0,F=0,we=0,K=3e3,ee=!1;const B=50,q=-10;let Y=B,Pe=0,J=!0,We=0;const Ke=2,se=-30,oe=0,G={body:9062,rotors:16737792,details:16777215};function Qe(u,n){if(!d){console.warn("Drone model not loaded yet");return}u&&(G.body=typeof u=="string"?parseInt(u.replace("#",""),16):u),n&&(G.rotors=typeof n=="string"?parseInt(n.replace("#",""),16):n),d.traverse(t=>{t.isMesh&&t.material&&(Array.isArray(t.material)?t.material:[t.material]).forEach(r=>{(r.isMeshStandardMaterial||r.isMeshPhongMaterial||r.isMeshLambertMaterial)&&(t.name&&/body/i.test(t.name)?r.color.setHex(G.body):t.name&&/rotor/i.test(t.name)&&r.color.setHex(G.rotors),r.needsUpdate=!0)})}),console.log("✅ Colors updated:",{body:`#${G.body.toString(16)}`,rotors:`#${G.rotors.toString(16)}`})}window.changeDroneColor=Qe;function et(u){if(!u){console.warn("No texture path(s) provided");return}const n=b[1]?.userData.sceneObject;if(!n||!n.group){console.warn("Sky scene or cloud group not found");return}const t=Array.isArray(u)?u:[u],a=new fe,r=[];let o=0;t.forEach((e,i)=>{a.load(e,s=>{if(console.log(`✅ Cloud texture ${i+1} loaded successfully`),s.flipY=!1,r[i]=s,o++,o===t.length){const c=r.filter(S=>S!==void 0);n.scene.userData.cloudTextures=c;const l=n.group;if(l.clear(),c.length===0){console.warn("No valid textures loaded");return}const p=45,v=30,M=20,m=250,h=250,f=25,g=Math.ceil(m/f)+2,w=Math.ceil(h/f)+2,x=3,W=1.5;for(let S=0;S<x;S++){const O=p+S*W,A=.5-S*.1;for(let k=0;k<g;k++)for(let E=0;E<w;E++){const Z=(Math.random()-.5)*f*1.2,N=(Math.random()-.5)*f*1.2,C=(k-g/2)*f+Z+S*2,U=(E-w/2)*f+N+S*2,$=c[Math.floor(Math.random()*c.length)],D=xe(C,O,U,v,M,$,A);D&&l.add(D)}}}},void 0,s=>{if(console.warn(`⚠️ Failed to load cloud texture ${i+1}:`,s),o++,o===t.length){const c=r.filter(l=>l!==void 0);if(c.length>0){n.scene.userData.cloudTextures=c;const l=n.group;l.clear();const p=45,v=30,M=20,m=250,h=250,f=25,g=Math.ceil(m/f)+2,w=Math.ceil(h/f)+2,x=3,W=1.5;for(let S=0;S<x;S++){const O=p+S*W,A=.5-S*.1;for(let k=0;k<g;k++)for(let E=0;E<w;E++){const Z=(Math.random()-.5)*f*1.2,N=(Math.random()-.5)*f*1.2,C=(k-g/2)*f+Z+S*2,U=(E-w/2)*f+N+S*2,$=c[Math.floor(Math.random()*c.length)],D=xe(C,O,U,v,M,$,A);D&&l.add(D)}}}}})})}function xe(u,n,t,a,r,o,e=.5){if(!o)return null;const i=Math.max(a,r),s=new ue(i,i),c=new He({map:o,transparent:!0,opacity:e,depthWrite:!1,side:De,roughness:.8,metalness:0});o.wrapS=ve,o.wrapT=ve,o.flipY=!1;const l=new ie(s,c);return l.position.set(u,n,t),l.rotation.z=(Math.random()-.5)*Math.PI*.3,l.rotation.x=(Math.random()-.5)*Math.PI*.1,l.rotation.y=(Math.random()-.5)*Math.PI*.1,l.userData.originalY=n,l.userData.originalZ=t,l.userData.originalRotationZ=l.rotation.z,l}window.setCloudTexture=et;function tt(){if(re&&R&&H){console.log("Animation already initialized, skipping init()...");return}const u=document.getElementById("drone-canvas");if(!u){console.error("Canvas not found");return}H=new Ze({canvas:u,antialias:!0}),H.setPixelRatio(Math.min(window.devicePixelRatio,2)),H.setSize(window.innerWidth,window.innerHeight),R=new Q,R.background=new I(1118481),L=new Se(55,window.innerWidth/window.innerHeight,.01,1e3),L.position.set(0,15,15),L.lookAt(0,0,0),at(),R=b[0],rt(),window.addEventListener("resize",lt,!1),window.addEventListener("wheel",dt,{passive:!1}),window.addEventListener("touchstart",ut,{passive:!1}),window.addEventListener("touchmove",ft,{passive:!1}),window.addEventListener("touchend",mt,{passive:!1}),Ae()}class ot{constructor(){this.scene=new Q,this.scene.background=new I(0),this.scene.add(new ce(16777215,1.2));const n=new le(16777215,1.5);n.position.set(5,10,5),this.scene.add(n);const t=new de(16777215,1,100);t.position.set(0,0,10),this.scene.add(t);const a=new $e,r=800,o=new Float32Array(r*3),e=8,i=280,s=1200;for(let m=0;m<r*3;m+=3){const h=Math.random()*Math.PI*2,f=Math.pow(Math.random(),.4),g=e+f*(i-e),w=-Math.random()*s;o[m]=g*Math.cos(h),o[m+1]=g*Math.sin(h),o[m+2]=w}a.setAttribute("position",new je(o,3));const c=document.createElement("canvas");c.width=64,c.height=64;const l=c.getContext("2d"),p=l.createRadialGradient(32,32,0,32,32,32);p.addColorStop(0,"rgba(255, 255, 255, 1)"),p.addColorStop(.5,"rgba(255, 255, 255, 0.8)"),p.addColorStop(1,"rgba(255, 255, 255, 0)"),l.fillStyle=p,l.fillRect(0,0,64,64);const v=new Ce(c),M=new Be({map:v,color:16777215,size:2.5,sizeAttenuation:!0,transparent:!0,alphaTest:.1,opacity:.9});this.stars=new Ie(a,M),this.scene.add(this.stars),this.scene.userData.stars=this.stars,this.createAuroraTunnel()}createAuroraTunnel(){this.auroraLayers=[];for(let t=0;t<20;t++){const a=60+t*2,r=64,o=new ue(a,a,r,r),e=new Me({uniforms:{time:{value:0},index:{value:t},total:{value:20},dronePos:{value:new T(0,0,0)}},vertexShader:`
                varying vec2 vUv;
