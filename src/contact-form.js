...
function initForm(form, translations, formType = "contact") {
    ...
    form.addEventListener("submit", async function (e) {
        ...
        if (!name) {
            showFieldError(
                "name",
                formTranslations?.errors?.name || translations?.contact?.form?.errors?.name || "Meno je povinné pole."
            );
            hasErrors = true;
        }
        ...
        if (!email) {
            showFieldError(
                "email",
                formTranslations?.errors?.email ||
                    translations?.contact?.form?.errors?.email ||
            ...
            showFieldError(
                "email",
                formTranslations?.errors?.emailInvalid ||
                    translations?.contact?.form?.errors?.emailInvalid ||
        ...
        if (phoneField && !phone) {
            showFieldError(
                "phone",
                formTranslations?.errors?.phone ||
                    translations?.contact?.form?.errors?.phone ||
        ...
        if (!message) {
            showFieldError(
                "message",
                formTranslations?.errors?.message ||
                    translations?.contact?.form?.errors?.message ||
        ...
        if (consentField && !consent) {
            showFieldError(
                "consent",
                formTranslations?.errors?.consent ||
                    translations?.contact?.form?.errors?.consent ||
        ...
        try {
            ...
            errorBox.textContent =
                formTranslations?.errors?.submit ||
                translations?.contact?.form?.errors?.submit ||
